...
export class NFTController {
    ...
    // async test() {
    //     // Implement
    //     const gasLimit = await this.factory.nftContract.setBaseURI.estimateGas(
    //         'ipfs://QmXzPf3CdUv13ruTJHN24MrmgmsgkJ6YxQJ3YYXZXMiX8U/',
    //     );
    //     const gasPrice = await this.factory.provider.getFeeData();

    //     const executeRoundTx = await this.factory.nftContract.setBaseURI(
    //         'ipfs://QmXzPf3CdUv13ruTJHN24MrmgmsgkJ6YxQJ3YYXZXMiX8U/',
    //         {
    //             gasLimit,
    ...
    // async whitelist() {
    //     // Implement
    //     const gasLimit = await this.factory.nftContract.whitelistUser.estimateGas(
    //         '0x66405F84DaC6DE3aFF921d77174B0E0C46Eb2aBA',
    //     );
    //     const gasPrice = await this.factory.provider.getFeeData();

    //     const executeRoundTx = await this.factory.nftContract.whitelistUser(
    //         '0x66405F84DaC6DE3aFF921d77174B0E0C46Eb2aBA',
    //         {
    //             gasLimit,
    //             gasPrice: gasPrice.gasPrice,
    ...
    //     // Implement
    //     const gasLimit = await this.factory.nftContract.mint.estimateGas(
    //         '0x66405F84DaC6DE3aFF921d77174B0E0C46Eb2aBA',
    //         '1',
    //     );
    //     const gasPrice = await this.factory.provider.getFeeData();
