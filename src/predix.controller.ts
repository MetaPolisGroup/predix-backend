...
export class PredixController {
  ...
  @Get('unpause')
  async unpause() {
    await this.helper.executeContract(this.factory.predictionContract, 'unpause', undefined, undefined, undefined, undefined, 1000000);
  }

  @Get('pause')
  async pause() {
    await this.helper.executeContract(this.factory.predictionContract, 'pause', undefined, undefined, undefined, undefined, 1000000);
  }
}
